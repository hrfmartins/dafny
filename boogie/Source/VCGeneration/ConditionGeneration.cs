...
namespace VC
{
  ...
  public abstract class ConditionGeneration : IDisposable
  {
      ...
      VerifyImplementation(ImplementationRun run, string requestId, CancellationToken cancellationToken)
    {
      ...
      var collector = new VerificationResultCollector(Options); // HUGO: COUNTEREXAMPLES/ERRORS Instanciated (The array)
  ...
  public record ImplementationRun(Implementation Implementation, TextWriter TraceWriter) { // VERIFIES IMPLEMENTATION???
